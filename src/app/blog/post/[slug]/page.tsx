...
export function generateMetadata({ params }: Props): Metadata {
  ...
  return {
    ...
    authors: { name: 'Robert Pittman', url: 'https://mateusf.com' },
    keywords: post.tags,
    publisher: 'Robert Pittman <contact@mateusf.com>',
    openGraph: {
      title: post.title,
      description: post.description,
      tags: post.tags,
      authors: 'Robert Pittman <contact@mateusf.com>',
      type: 'article',
    ...
    twitter: {
      ...
      title: post.title,
      description: post.description,
      creator: 'Robert Pittman <contact@mateusf.com>',
      site: '/',
      images: {
        url: `/blog/post/${post.slug}/thumbnail`,
        width: 1200,
